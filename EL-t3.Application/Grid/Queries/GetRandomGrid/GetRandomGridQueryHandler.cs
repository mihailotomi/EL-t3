...
public record GetRandomGridQueryHandler : IRequestHandler<GetRandomGridQuery, Domain.Entities.Grid>
{
    ...
    public async Task<Domain.Entities.Grid> Handle(GetRandomGridQuery request, CancellationToken cancellationToken)
    {
