...
internal static class CountryImageUrlHelper
{
    private static readonly Dictionary<string, string> CountryCodesMapping = new Dictionary<string, string>
    {
        ...
        { "CRO", "HR" }, { "CUB", "CU" }, { "CUW", "CW" }, { "CYP", "CY" }, { "CZE", "CZ" },
        ...
        { "GIB", "GI" }, { "GRC", "GR" }, { "GRE", "GR" }, { "GRL", "GL" }, { "GRD", "GD" },
        ...
        { "ZMB", "ZM" }, { "ZWE", "ZW" }, {"GER", "DE"}
    };

    public static string GetCountryImageUrl(string longCode)
    {
        CountryCodesMapping.TryGetValue(longCode, out var shortCode);
        if (shortCode == null)
        {
            throw new ArgumentException("No country with such code", shortCode);
        }

        return $"https://flagcdn.com/256x192/{shortCode.ToLower()}.png";
    }
}
